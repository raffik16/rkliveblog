    ...
    <>
      <div>
        ...
        <div className="flex sm:space-x-24">
          <div className="hidden h-full max-w-[280px] min-w-[280px] flex-wrap rounded-sm bg-gray-50 pt-5 shadow-md sm:flex dark:bg-gray-900/70 dark:shadow-gray-800/40">
