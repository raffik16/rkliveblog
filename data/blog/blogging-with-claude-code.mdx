...
date: '2025-10-27'
lastmod: '2026-01-28'
tags: ['claude-code', 'blogging', 'workflow', 'ai', 'productivity', 'content-creation']
draft: false
summary: 'Create blog posts with natural language commands and voice dictation using Claude Code. From idea to published MDX in minutes - no manual file creation, no YAML syntax errors, no context switching.'
authors: ['default']
layout: PostLayout
---
