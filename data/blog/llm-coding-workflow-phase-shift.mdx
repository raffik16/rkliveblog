...
date: '2026-01-28'
tags: ['ai', 'coding', 'workflow', 'claude-code', 'software-engineering']
draft: false
summary: 'In December 2025, LLM coding agents crossed a threshold. Here are notes from the other side - where 80% of programming happens in English.'
authors: ['default']
layout: PostLayout
---
