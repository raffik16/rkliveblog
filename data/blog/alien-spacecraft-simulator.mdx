...
date: '2025-11-22'
lastmod: '2026-01-28'
tags: ['webgl', 'canvas', 'gsap', 'nextjs', 'react', 'animation', 'simulation', 'javascript']
draft: false
summary: 'How I built an immersive alien spacecraft simulator in the browser. Warp speed visualization, velocity gauges, anti-gravity physics, and stealth systems - all using Canvas API and GSAP animations.'
authors: ['default']
layout: PostLayout
---
...
- **Preset Maneuvers**:
  - _Cautious Approach_: 30% speed, slow 8s acceleration
  - _Emergency Escape_: 90% speed, rapid 2s acceleration
