...
export const heroIntros: HeroIntro[] = [
  {
    ...
    year: '500 BCE',
    description:
      'Inspired by the theatrical traditions of ancient amphitheaters, where velvet curtains would rise to reveal the dramatic world within.',
  ...
  },
  {
    ...
    year: '1450 CE',
    description:
      'Echoing the moment a leather-bound tome is opened, revealing stories and wisdom preserved for centuries.',
  ...
  },
  {
    ...
    year: '1500 CE',
    description:
      'Great wooden doors of cathedrals and palaces swinging open to welcome visitors into magnificent spaces.',
  ...
  },
  {
    ...
    year: '1769 CE',
    description:
      'The gentle rotation of slats revealing morning light, a daily ritual transformed into digital poetry.',
  ...
  },
  {
    ...
    year: '1840 CE',
    description:
      'The anticipation of breaking a wax seal and unfolding a personal letter, intimate and expectant.',
  ...
  },
  {
    ...
    year: '1950 CE',
    description:
      'The warm glow of vacuum tubes, static clearing to reveal the magic of broadcast entertainment.',
  ...
  },
  {
    ...
    year: '1900 CE',
    description:
      'The mechanical iris of a camera lens opening to capture a perfect moment in time.',
  ...
  },
  {
    ...
    year: 'Eternal',
    description:
      "Nature's own reveal - the sun cresting the horizon, painting the world in golden light.",
  ...
  },
  {
    ...
    year: '1680 CE',
    description:
      'The delicate art of Japanese paper folding reversed, complexity becoming elegant simplicity.',
  ...
  },
  {
    ...
    year: '1920 CE',
    description:
      "The countdown, the projector's whir, and the silver screen coming alive with moving pictures.",
  ...
  },
  {
    ...
    year: '1930 CE',
    description:
      'The ding of arrival, polished brass doors parting to reveal the grandeur of a new floor.',
  ...
  },
  {
    ...
    year: '1960 CE',
    description:
      'The satisfying click of tumblers, the turn of the wheel, and the swing of impenetrable steel.',
